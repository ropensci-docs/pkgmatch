...
maintainers - to work on `pkgmatch`. 😊
...
- new_issue:
  <https://github.com/ropensci-review-tools/pkgmatch/issues/new>
- website: <https://docs.ropensci.org/pkgmatch/>
- citation:
  <https://ropensci-review-tools.github.io/pkgmatch/authors.html>
...
Think `pkgmatch` is useful? Let others discover it, by telling them in
...
documentation](https://docs.ropensci.org/pkgmatch/) to see if you can
find a solution. Still stuck? Post your question as an [issue on
GitHub](https://github.com/ropensci-review-tools/pkgmatch/issues). While
...
list](https://github.com/ropensci-review-tools/pkgmatch/issues) to see
...
Using `pkgmatch` and discovered a bug? That’s annoying! Don’t let others
have the same experience and report it as an [issue on
GitHub](https://github.com/ropensci-review-tools/pkgmatch/issues/new) so
...
- Include the version of `pkgmatch` with the following line in your
  `reprex` code:
...
issue](https://github.com/ropensci-review-tools/pkgmatch/issues/new) and
...
list](https://github.com/ropensci-review-tools/pkgmatch/issues) and
...
1.  Fork [this repo](https://github.com/ropensci-review-tools/pkgmatch/)
...
The `pkgmatch` coding style diverges somewhat from [the commonly used
...
code readability. Code references in `pkgmatch` are separated by
...
`pkgmatch` code opts for the former style, with the natural result that
one ends up writing
